...
export default class Settings extends React.Component<Props> {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (
      (!prevProps.githubData && githubData) ||
      prevProps.settingSwitch !== settingSwitch
    ) {
      this.setState({
        githubRepo: `https://api.github.com/repos/lemonbase-tech/packages/contents/packages/untitled-icon/package.json\?ref\=main`,
        githubToken: "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",
      });
    }
  }
  render() {
